(function () {
    ...
    const elements = {
        ...
        urinePotassium: byId('urine-potassium'), urineSampleLocal: byId('urine-sample-local'),
        otherOutput: byId('other-output'), otherNaLoss: byId('other-na-loss'),
    ...
    function readForm() {
        return {
            ...
            urinePotassium: numberOrNull(elements.urinePotassium), urineSampleLocal: elements.urineSampleLocal.value,
            otherOutputMl: numberOrNull(elements.otherOutput),
